...
export default function Footer(): React.ReactElement {
    return (
        <footer className={styles.appFooter}>
            <section id={styles.footerLogo} role="presentation">
            ...
            <section id={styles.footerContact} role="presentation">
                <address id={styles.socials}>
                    <a
                        href="https://github.com/tominator633"
                        target="_blank"
             ...
             {/*        <a
                        href="https://www.linkedin.com/in/tomas-r-65916ab8/"
                        target="_blank"
                        rel="noreferrer noopener"
