...
import { addCommunity, deleteCommunity, setCurrentCommunity } from "../../model/communitiesSlice";
...
export default function CommunityCard ({ content, isSwiperCommunity }: CommunityProps): React.ReactElement {
    ...
    const handleAddCommunityClick = (): void => {
        dispatch(addCommunity(content));
    };

    const handleDeleteCommunityClick = (): void => {
        dispatch(deleteCommunity({ id: content.id }));
    };

    const handleSrDetailBtnClick = (): void => {
        dispatch(setCurrentCommunity(content));
    };
    ...
    return (
        <section className={styles.srCon} 
            ...
            <figure className={styles.srBanner} 
                    role="presentation">
                {content.bannerImg && !bannerImgError && 
            ...
            <div className={styles.srInfo} 
                role="presentation">
                <div className={styles.srIconWrapper}>
                    <figure className={styles.srIcon} 
                        role="presentation">
                        {content.iconImg && !iconImgError ? (
                ...
                <div className={styles.srNameTitle} 
                    ...
                    <p className={styles.srSubscribers}>
                        ...
                        {formatNumberWithSpaces(content.counts.subscribers ?? 0)}
                    </p>
                </div>
            </div>
            ...
            <div className={styles.srButtons} 
                ...
                <Link
                    ...
                    aria-label="Open information window for this community"
                >
