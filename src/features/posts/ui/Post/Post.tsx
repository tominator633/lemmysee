...
import { savePost, unsavePost, selectSavedPosts, setCurrentPost } from "../../model/postsSlice";
        ...
        <article className={styles.post} 
            ...
            <div className={styles.postColumn} 
                ...
                <div className={styles.postContent}
                    ...
                    {content.text && renderSelfText(content.text) && (
                        <p  className={styles.selftextContent}
                            dangerouslySetInnerHTML={renderSelfText(content.text) as { __html: string }}  // Use the renderSelfText method
